...
let app = {
    cookie: '',
    userAgent: '',
    ignore: ['cookie','userAgent','options','sapisid','status','reason','cancelled','canEmbed','isLive','debugOn'],
    test_options: {
        id: 'PLQ_voP4Q3cffatM_zKUO5-woz34KyLrPL', //'J7', //any playlist id
        quantity: 100 // number of results to fetch. You can get a further 100 more videos (if available) with subsequent playlist.continued() calls
    }
}
