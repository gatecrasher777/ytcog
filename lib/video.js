...
class Video extends Model {
	...
	async fetchEmbed() {
		...
		let body = await this.httpsGet(
			`https://www.youtube.com/oembed?format=json&url=https://www.youtube.com/watch?v=${this.options.id}`,
			{
				path: `/oembed?format=json&url=https://www.youtube.com/watch?v=${this.options.id}`,
				headers: hdrs,
			},
			true,
		);
