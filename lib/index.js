...
class Download {
	...
	constructor(options, cookie, userAgent, minigetOptions, debug = false) {
		this.session = new Session(cookie, userAgent, minigetOptions);
		this.video = null;
...
const ytcog = {
	...
	Video: Video,
	Download: Download,
	dl: async(options, cookie, userAgent, minigetOptions, debug = false) => {
		let download = new Download(options, cookie, userAgent, minigetOptions, debug);
